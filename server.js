...
// ============================================
// 🚨 CRITICAL: HEALTH CHECK PRIMEIRO!
// Esta rota DEVE estar ANTES de qualquer middleware
// para o EasyPanel health check funcionar
// ============================================
...
console.log('✅ Health check routes registered (BEFORE all middlewares)');

// Agora vêm todos os outros middlewares...
